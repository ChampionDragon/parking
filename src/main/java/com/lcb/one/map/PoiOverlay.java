...
public class PoiOverlay extends OverlayManager {
    ...
    public final List<OverlayOptions> getOverlayOptions() {
        ...
        for (int i = 0; i < mPoiResult.getAllPoi().size()
            ...
            /*只要一个坐标用这个*/
            BitmapDescriptor one = BitmapDescriptorFactory.fromResource(R.mipmap.ic_marker_poi);
            /*坐标超过两个用这个*/
            BitmapDescriptor two = BitmapDescriptorFactory.fromAssetWithDpi("Icon_mark" + markerSize + ".png");

            markerList.add(new MarkerOptions()
                    .icon(two).extraInfo(bundle)
